...
class SM4:
    ...
    def encrypt(
        ...
        try:
            ...
            logger.info(f"Text successfully encrypted and saved to {path_to_encrypted}")
            return encrypted
        except Exception as e:
            logger.error(f"Error during SM4 encryption: {e}")
    ...
    def decrypt(
        ...
        try:
            ...
            logger.info(f"Text successfully decrypted and saved to {path_to_decrypted}")
            return unpadded_text
        except Exception as e:
            logger.error(f"Error during SM4 decryption: {e}")